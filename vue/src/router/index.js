...
const router = createRouter({
  ...
  routes: [
    ...
    {path: '/manager', component: () => import('../views/Mananger.vue'), children: [
      ...
      {path: 'article', meta:{title: '文章管理頁面'}, component: () => import('../views/Article.vue')},
      {path: 'department', meta:{title: '部門管理頁面'}, component: () => import('../views/Department.vue')},
      {path: 'employee', meta:{title: '員工管理頁面'}, component: () => import('../views/Employee.vue')},
      {path: 'admin', meta:{title: '管理員管理頁面'}, component: () => import('../views/Admin.vue')},
